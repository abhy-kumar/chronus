...
/**
 * Created by jdhru on 27/01/2018.
 */

public class imageh {
    public static Bitmap Drawrec (Bitmap mBitmap, FaceRectangle faceRectangle,String status)
    {
    ...
    private static void drawTextOnBitmap(Canvas canvas, int ts, int cX, int cY, int color, String status) {
        Paint paint = new Paint();
        paint.setAntiAlias(true);
